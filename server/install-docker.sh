...
ln -sf /usr/src/server/SumSynth/sumsynth/.stack-work/dist/x86_64-linux-tinfo6-libc6-pre232/ghc-9.2.7/build/sumsynth-exe/sumsynth-exe "${BIN}/${SUMSYNTH_LINK}"
...
ln -sf "/usr/src/server/${JSONPARSER_EXE}" "${BIN}/${JSONPARSER_LINK}"
